                ...
                if (client.signals.get(.cert_errors)) {
                    ...
                    client.state.certificate_info = .{
                        ...
                        .cert_error = .{
                            ...
                            .code = bun.handleOom(bun.dupeZ(bun, bun.default_allocator, u8, certError.code)),
                            .reason = bun.handleOom(bun.dupeZ(bun, bun.default_allocator, u8, certError.reason)),
                        },
                    };
        ...
        if (!ssl_ptr.isInitFinished()) {
            ...
            if (!strings.isIPAddress(_hostname)) {
                if (_hostname.len < temp_hostname.len) {
                    ...
                    hostname = bun.dupeZ(bun, bun.default_allocator, u8, _hostname) catch unreachable;
