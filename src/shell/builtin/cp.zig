...
pub const ShellCpTask = struct {
    ...
    fn runFromThreadPoolImpl(this: *ShellCpTask) ?bun.shell.ShellErr {
        ...
        this.src_absolute = bun.handleOom(bun.dupeZ(bun, bun.default_allocator, u8, src[0..src.len]));
        this.tgt_absolute = bun.handleOom(bun.dupeZ(bun, bun.default_allocator, u8, tgt[0..tgt.len]));
