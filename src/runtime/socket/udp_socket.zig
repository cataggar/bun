...
pub const UDPSocket = struct {
    ...
    pub fn udpSocket(globalThis: *JSGlobalObject, options: JSValue) bun.JSError!JSValue {
        ...
        const hostname_z = bun.handleOom(bun.dupeZ(bun, bun.default_allocator, u8, hostname_slice.slice()));
        ...
        if (this.config.connect) |*connect| {
            ...
            const address_z = bun.handleOom(bun.dupeZ(bun, bun.default_allocator, u8, address_slice.slice()));
