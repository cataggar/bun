...
pub fn resultToJS(this: *const Result, globalThis: *jsc.JSGlobalObject) bun.JSError!JSValue {
    ...
    obj.put(globalThis, jsc.ZigString.static("family"), switch (this.address) {
        .ip4 => JSValue.jsNumber(4),
        .ip6 => JSValue.jsNumber(6),
    });
    obj.put(globalThis, jsc.ZigString.static("ttl"), JSValue.jsNumber(this.ttl));
    return obj;
}
pub fn addressToJS(address: anytype, globalThis: *jsc.JSGlobalObject) bun.JSError!jsc.JSValue {
