...
pub const PatchTask = struct {
    ...
    pub fn newCalcPatchHash(
        ...
        const patchfile_path = bun.handleOom(bun.dupeZ(bun, manager.allocator, u8, patchdep.path.slice(manager.lockfile.buffers.string_bytes.items)));
        ...
        const pt = bun.new(PatchTask, .{
            ...
            .callback = .{
                .apply = .{
                    ...
                    // modified
                    .cache_dir_subpath = bun.handleOom(bun.dupeZ(bun, pkg_manager.allocator, u8, stuff.cache_dir_subpath)),
                    .cache_dir_subpath_without_patch_hash = bun.handleOom(bun.dupeZ(bun, pkg_manager.allocator, u8, stuff.cache_dir_subpath[0 .. std.mem.indexOf(u8, stuff.cache_dir_subpath, "_patch_hash=") orelse @panic("This is a bug in Bun.")])),
                },
            },
            .manager = pkg_manager,
            .project_dir = FileSystem.instance.top_level_dir,
