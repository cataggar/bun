        ...
        .Authentication => {
            ...
            switch (auth) {
                .SASL => {
                    ...
                    const mechanism = bun.fmt.bufPrintZ(&mechanism_buf, "n,,n=*,r={s}", .{this.authentication_state.SASL.nonce()}) catch unreachable;
                ...
                .MD5Password => |md5| {
                    ...
                    const final_password = bun.fmt.bufPrintZ(&final_password_buf, "md5{s}", .{final_hash_str_output}) catch unreachable;
